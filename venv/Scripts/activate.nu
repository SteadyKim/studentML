...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\kimta\PycharmProjects\student-placement-predictor-android-app\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\kimta\PycharmProjects\student-placement-predictor-android-app\venv\Scripts\deactivate.nu'
